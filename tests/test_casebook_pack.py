"""Regression checks for the watch-sys-process-index casebook."""
...
from casebook.harness import assert_expected, watch_sys_process_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_sys_process_index_summary(), assert_expected())
